...
Refer to [reproduce_experiments.ipynb](/metric/reproduce_experiments.ipynb) for the implementation of this approach. In this notebook we show that it yield wignificant improvement in correlation with human judgements for most pf the standartly used content similarity metrics. 
